...
public class DownloadInscriptionCertificatePdfUC {
    ...
    public byte[] execute(PersonEntity person, Integer inscriptionId) {
        ...
        if (inscription.getFileCertificateName() == null) {
            throw new ValidatorException("Não foi gerado pdf do certificado.");
        }
        return fileHandlerGTW.getFile(inscription.getFileCertificateName(), inscription.getFileCertificateS3());
    }
